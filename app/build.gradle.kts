...
android {
    namespace = "com.gudaoweb.app"
    compileSdk = libs.versions.compile.sdk.get().toInt()

    defaultConfig {
        applicationId = "com.gudaoweb.app"
...
base {
    archivesName.set("Gudaoweb-v${android.defaultConfig.versionName}(${android.defaultConfig.versionCode})")
}
